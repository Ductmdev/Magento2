...
return [
    'modules' => [
        ...
        'CommunityEngineering_FixCheckoutStaging' => 1,
        'CommunityEngineering_JapanesePostalCode' => 0,
        'CommunityEngineering_JapaneseRegion' => 0,
        'CommunityEngineering_JapaneseStoreAddress' => 1,
        'CommunityEngineering_JapaneseStorePickupAddress' => 1,
        'CommunityEngineering_JapaneseUrlRewrite' => 1,
        'CommunityEngineering_JapaneseYenFormatting' => 1,
        'CommunityEngineering_Kuromoji' => 0,
        'Mageplaza_Core' => 1,
        'Mageplaza_Blog' => 1,
        'Bap_CustomBlog' => 1,
        'Mageplaza_Smtp' => 1,
